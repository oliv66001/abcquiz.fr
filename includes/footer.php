<div class="container text-center" id="btnFace">
  <div class="row">
    <div class="col">
<div class="fb-like" data-href="https://developers.facebook.com/docs/plugins/" data-width="225px" data-layout="standard" data-action="like" data-size="small" data-share="true"></div></div></div>
  </div>
<div class="container-fluid ;navbar navbar-dark navbar-expand-lg" style="background-color: rgba(65, 75, 85, 0.226)">
  <footer class="row" style="text-align: center">

    <div class="social col-12" style="text-align: center">
   
      <a target="_blank" href="https://www.instagram.com/"><em class="icon ion-social-instagram"><svg
            xmlns="https://www.w3.org/2000/svg " style="margin: 20px" width="26 " height="26 " fill="currentColor "
        ...
        1.024-.044 2.515-.045v.002zm4.988 1.328a.96.96 0 1 0 0 1.92.96.96 0 0 0 0-1.92zm-4.27 1.122a4.109 4.109 0 1 0 0 8.217 4.109 4.109 0 0 0 0-8.217zm0 1.441a2.667 2.667 0 1 1 0 5.334 2.667 2.667 0 0 1 0-5.334z " />
          </svg></em></a><a target="_blank" href="https://www.facebook.com/search/top/?q=abcquiz"><em
          class="icon ion-social-facebook"><svg xmlns="https://www.w3.org/2000/svg " style="margin: 20px" width="26 "
    ...
    <ul class="list-inline col-12" style="padding-bottom: 5px">
      <li class="list-inline-item"><a href="index.php" style="color: black">Quiz</a></li>
      <li class="list-inline-item">
        <a href="mieuxNousConnaitre.php" style="color: black">A propos</a>
      </li>

      <li class="list-inline-item">
        <a href="CGU abcquiz.fr/CGU.pdf" style="color: black" target="_blank">CGU</a>
      </li>
      <li class="list-inline-item">
        <a href="indexContact.php" style="color: black">Contact</a>
      </li>
      <li class="list-inline-item">
        <a href="cookies.php" style="color: black">Politique des Cookies</a>
      </li>
    </ul>

    <span class="text-center">
      created by oliv66001 © 2022 V 1.2.0
    </span>
  </footer>
</div>

<script src="script.js/js.cookie.min.js"></script>
